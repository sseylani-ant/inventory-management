export default {
  ...
  restocking: {
    title: '補充発注',
    description: '需要予測に基づいて補充を計画・発注',
    budgetLabel: '利用可能予算',
    recommendationsTitle: '補充推奨品目',
    noRecommendations: 'この予算内で推奨できる品目がありません。予算を増やしてください。',
    placeOrder: '発注する',
    placing: '発注中...',
    orderSuccess: '注文 {orderNumber} を発注しました — 配達まで{days}日',
    viewOrders: '注文で表示',
    loadError: '推奨品目の読み込みに失敗しました',
    placeError: '発注に失敗しました',
    table: {
      rank: '#',
      sku: 'SKU',
      item: '品目',
